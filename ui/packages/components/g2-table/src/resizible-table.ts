export class Resizer {
  ...
  private onMouseMove = (e: MouseEvent) =>
    requestAnimationFrame(() => {
      ...
      const handlerWidth = (column.ref.querySelector(".resize-handle") as HTMLElement).offsetWidth;
      const width = horizontalScrollOffset + e.clientX - (column.ref.offsetLeft - handlerWidth/2);
